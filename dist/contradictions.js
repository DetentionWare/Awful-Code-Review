...
exports.defaultContradictionEngine = exports.ContradictionEngine = exports.contradictionRules = void 0;
/**
...
class ContradictionEngine {
    constructor(rules = exports.contradictionRules) {
        this.commentHistory = [];
        this.rules = rules;
    }
    /**
     ...
     */
    recordComment(file, line, body, persona, explicitTags) {
...
exports.defaultContradictionEngine = new ContradictionEngine();
