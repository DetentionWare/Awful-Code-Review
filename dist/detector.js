...
exports.defaultDetector = exports.PatternDetector = exports.patterns = void 0;
/**
...
class PatternDetector {
    constructor(customPatterns) {
        this.patterns = { ...exports.patterns, ...customPatterns };
     ...
     */
    patternMatchesFileType(pattern, extension) {
     ...
     */
    detectInLine(line, lineNumber, filename) {
            ...
            try {
                ...
                while ((match = regex.exec(line)) !== null) {
                    ...
                    matches.push({
                        ...
                        lineContent: line,
                        matchedText: match[0],
                        triggersPersonas: pattern.triggersPersonas,
                    });
                }
            }
            catch (e) {
...
exports.defaultDetector = new PatternDetector();
