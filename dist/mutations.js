...
exports.defaultMutationEngine = exports.MutationEngine = exports.severityLabels = exports.mutations = void 0;
/**
...
class MutationEngine {
    constructor(enabledMutations = Object.keys(exports.mutations), mutationProbability = 0.4) {
     ...
     */
    applyRandomMutation(comment) {
        if (Math.random() > this.mutationProbability) {
            return { comment, applied: null };
        }
        // Pick a random mutation type
        const mutationType = this.enabledMutations[Math.floor(Math.random() * this.enabledMutations.length)];
        const mutationsOfType = exports.mutations[mutationType];
     ...
     */
    applyMutations(comment, maxMutations = 2) {
        let result = comment;
        let appliedCount = 0;
     ...
     */
    addSeverityLabel(comment, actualSeverity, mismatchProbability = 0.3) {
        ...
        if (Math.random() < mismatchProbability) {
            ...
            const allSeverities = Object.keys(exports.severityLabels);
        ...
        const labels = exports.severityLabels[displaySeverity];
     ...
     */
    generateContradiction(originalComment) {
...
exports.defaultMutationEngine = new MutationEngine();
